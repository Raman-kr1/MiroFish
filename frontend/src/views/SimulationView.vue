 ...
 * When user returns from Step 3 to Step 2
 */
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      try {
        ...
        // If exception during graceful close, try forced stop
        await forceStopSimulation()
      }
    } else {
      // Env not running, but check process status
    ...
    // Failure checking status shouldn't block flow
