...
class ProjectStatus(str, Enum):
    ...
    GRAPH_BUILDING = "graph_building"    # Graph under construction
...
class Project:
    ...
    # Ontology info (populated after interface 1 generates it)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph info (populated after interface 2 completes)
...
class ProjectManager:
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get the path where extracted text is stored for the project"""
