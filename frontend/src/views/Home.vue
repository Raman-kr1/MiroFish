    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a paragraph of text, <span class="highlight-bold">MiroFish</span> can generate a parallel world consisting of up to <span class="highlight-orange">millions of Agents</span> based on the realistic seeds within it. Inject variables from a God's perspective to find the <span class="highlight-code">"local optimal solution"</span> in complex group interactions under dynamic environments.
            </p>
            <p class="slogan-text">
              Let the future replay among the Agent swarm, and let decisions win after a hundred battles<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby, ready to upload multiple unstructured data to initialize simulation sequence
          </p>
            ...
            <div class="console-section">
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-title">Drag and Drop File Upload</div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g. If B University announces the revocation of Xiao's punishment, what public opinion trend will it trigger)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Jump to Process page (use special flag to indicate new project)
    router.push({
      name: 'Process',
