...
const selectedProject = ref(null)  // comment
let observer = null
let isAnimating = false  // comment
let expandDebounceTimer = null  // comment
let pendingState = null  // comment
...
.grid-pattern {
  ...
  /*Anchor at top-left; when height changes, expand only at bottom without shifting existing grid*/
