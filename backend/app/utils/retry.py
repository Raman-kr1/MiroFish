        ...
        def wrapper(*args, **kwargs) -> Any:
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    logger.warning(
                        f"Function {func.__name__} failed attempt {attempt + 1}: {str(e)}, "
        ...
        async def wrapper(*args, **kwargs) -> Any:
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    logger.warning(
                        f"Async function {func.__name__} failed attempt {attempt + 1}: {str(e)}, "
                        f"retrying in {current_delay:.1f}s..."
                    )
        ...
        **kwargs
        ...
        for attempt in range(self.max_retries + 1):
            try:
                ...
                logger.warning(
                    f"API call failed attempt {attempt + 1}: {str(e)}, "
                    f"retrying in {current_delay:.1f}s..."
                )
