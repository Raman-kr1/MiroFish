...
2. Simulation scripts poll command directory, execute commands and write responses to responses/ directory
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        raise TimeoutError(f"Wait for command response timeout ({timeout} seconds)")
