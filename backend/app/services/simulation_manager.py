...
Manage Twitter and Reddit dual-platform parallel simulation
Use preset scripts + LLM intelligent configuration parameter generation
"""
...
class SimulationState:
    ...
    def to_simple_dict(self) -> Dict[str, Any]:
        """Simplified state dictionary (for API return)"""
        return {
            "simulation_id": self.simulation_id,
            "project_id": self.project_id,
            "graph_id": self.graph_id,
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Steps:
        1. Read and filter entities from Zep graph
        2. Generate OASIS Agent Profile for each entity (optional LLM enhancement, supports fallback)
        ...
        Args:
            ...
            use_llm_for_profiles: Whether to use LLM to generate detailed persona
            progress_callback: Progress callback function (stage, progress, message)
            parallel_profile_count: Number of parallel persona generation, default 3
        ...
        try:
            ...
            # Pass graph_id to enable Zep retrieval function, get richer context
            ...
            # Reddit has been saved in real-time during generation, save again here to ensure integrity
            if progress_callback:
                progress_callback(
            ...
            # Note: Run script remains in backend/scripts/ directory, no longer copied to simulation directory
