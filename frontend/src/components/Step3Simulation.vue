...
const phase = ref(0) // comment
const isStarting = ref(false)
const isStopping = ref(false)
const startError = ref(null)
const runStatus = ref({})
const allActions = ref([]) // comment
const actionIds = ref(new Set()) // comment
...
const doStartSimulation = async () => {
  ...
  try {
    const params = {
      ...
      platform: 'parallel',
      force: true,  // comment
      enable_graph_memory_update: true  // comment
    }
