...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required usage by Zep SDK, warning comes from dynamic class creation, safe to ignore
        ...
        def safe_attr_name(attr_name: str) -> str:
            """Convert reserved name to safe name"""
        ...
        for edge_def in ontology.get("edge_types", []):
            ...
            for attr_def in edge_def.get("attributes", []):
                ...
                # Zep API requires Field description, this is mandatory
                attrs[attr_name] = Field(description=attr_desc, default=None)
                annotations[attr_name] = Optional[str]  # Edge attribute use str type
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to clear (by checking processed status of each episode)"""
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict containing nodes and edges, including time info, attributes etc.
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
